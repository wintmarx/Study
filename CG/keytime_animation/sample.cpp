...
void Animate() {
    ...
    Time = (float)ms / 1000.;  // makes the value of Time between 0.
...
void Display() {
    ...
    if (animate_cam) {
        gluLookAt(cam_posX.GetValue(Time), cam_posY.GetValue(Time), cam_posZ.GetValue(Time), 0.f, 0.f, 0.f, 0.f, 1.f,
                  0.f);
    } else {
        gluLookAt(cam_posX.GetValue(0), cam_posY.GetValue(0), cam_posZ.GetValue(0), 0.f, 0.f, 0.f, 0.f, 1.f, 0.f);
    }
    ...
    glTranslated(light_posX.GetValue(Time), carousel_y, light_posZ.GetValue(Time));
    ...
    if (light_source_type == POINT_LIGHT) {
        SetPointLight(GL_LIGHT0, light_posX.GetValue(Time), carousel_y, light_posZ.GetValue(Time), light_color.r,
    ...
    SetMaterial(.0, .35, .0, 0.);
    glCallList(GridDL);

    glColor3f(0., 0., 1.);
    SetMaterial(dino_colorR.GetValue(Time), .20, 0, 10);
    glPushMatrix();
    glTranslated(dino_posX.GetValue(Time), 1., dino_posZ.GetValue(Time));
    glRotated(dino_rotY.GetValue(Time), 0, 1, 0);
...
void InitGraphics() {
    ...
    dino_colorR.Init();
    dino_colorR.AddTimeValue(0, 0);
    dino_colorR.AddTimeValue(1, 0.2);
    dino_colorR.AddTimeValue(4, 0.5);
    dino_colorR.AddTimeValue(5, 1.0);
    dino_colorR.AddTimeValue(8, 0.3);
    dino_colorR.AddTimeValue(10, 0);

    float step = 0.83333;
    light_posX.Init();
    light_posX.AddTimeValue(step * 0, 0);
    light_posX.AddTimeValue(step * 1, 3);
    light_posX.AddTimeValue(step * 3, 0);
    light_posX.AddTimeValue(step * 4, -3);
    light_posX.AddTimeValue(step * 6, 0);
    light_posX.AddTimeValue(step * 7, 3);
    light_posX.AddTimeValue(step * 9, 0);
    light_posX.AddTimeValue(step * 10, -3);
    light_posX.AddTimeValue(step * 12, 0);

    light_posZ.Init();
    light_posZ.AddTimeValue(step * 0, 0);
    light_posZ.AddTimeValue(step * 1, 3);
    light_posZ.AddTimeValue(step * 2, 6);
    light_posZ.AddTimeValue(step * 3, 9);
    light_posZ.AddTimeValue(step * 4, 6);
    light_posZ.AddTimeValue(step * 5, 3);
    light_posZ.AddTimeValue(step * 6, 0);
    light_posZ.AddTimeValue(step * 7, -3);
    light_posZ.AddTimeValue(step * 8, -6);
    light_posZ.AddTimeValue(step * 9, -9);
    light_posZ.AddTimeValue(step * 10, -6);
    light_posZ.AddTimeValue(step * 11, -3);
    light_posZ.AddTimeValue(step * 12, 0);

    dino_posX.Init();
    dino_posX.AddTimeValue(0, 0);
    dino_posX.AddTimeValue(3, 4);
    dino_posX.AddTimeValue(4, 5);
    dino_posX.AddTimeValue(7, 0);
    dino_posX.AddTimeValue(9, -1);
    dino_posX.AddTimeValue(10, 0);

    dino_posZ.Init();
    dino_posZ.AddTimeValue(0, 0);
    dino_posZ.AddTimeValue(3, 3);
    dino_posZ.AddTimeValue(4, -6);
    dino_posZ.AddTimeValue(7, -7);
    dino_posZ.AddTimeValue(9, 2);
    dino_posZ.AddTimeValue(10, 0);

    dino_rotY.Init();
    dino_rotY.AddTimeValue(0, 36.87);
    dino_rotY.AddTimeValue(3, -83.7);
    dino_rotY.AddTimeValue(4, 11.3);
    dino_rotY.AddTimeValue(7, -83.7);
    dino_rotY.AddTimeValue(9, -63.4);
    dino_rotY.AddTimeValue(10, 36.87);

    cam_posX.Init();
    cam_posX.AddTimeValue(0, 10);
    cam_posX.AddTimeValue(2, 5);
    cam_posX.AddTimeValue(4, -5);
    cam_posX.AddTimeValue(6, 0);
    cam_posX.AddTimeValue(8, 4);
    cam_posX.AddTimeValue(10, 10);

    cam_posY.Init();
    cam_posY.AddTimeValue(0, 5);
    cam_posY.AddTimeValue(2, 10);
    cam_posY.AddTimeValue(4, 15);
    cam_posY.AddTimeValue(6, 25);
    cam_posY.AddTimeValue(8, 12);
    cam_posY.AddTimeValue(10, 5);

    cam_posZ.Init();
    cam_posZ.AddTimeValue(0, 10);
    cam_posZ.AddTimeValue(2, 8);
    cam_posZ.AddTimeValue(4, 3);
    cam_posZ.AddTimeValue(6, 0);
    cam_posZ.AddTimeValue(8, 4);
    cam_posZ.AddTimeValue(10, 10);
}
